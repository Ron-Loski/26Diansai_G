...
int main(void)
{
  ...
  printf("ANALYZER_FW,H743VI_ADC_NO_AMP,build=20260730_3\r\n");
  printf("ANALYZER_CAL,profile=adc_no_amp,scale=0.968936,"
  ...
  while (1)
  {
    ...
    if ((HAL_GetTick() - AnalyzerStatusTick) >= 1000U)
    {
      ...
      printf("ANALYZER_STATUS,pll=%u,cfg=%u,busy=%u,ready=%u,"
             ...
             "fw=0730,pc11_mode=%lu,pc11_pupd=%lu,pc11_af=%lu,"
             "pc11_idr=%lu\r\n",
